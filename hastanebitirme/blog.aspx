<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blog.aspx.cs" Inherits="hastanebitirme.blog" %>
...
<header>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-5 text-lg">Sizden Gelenler</h1>
    ...
    <form id="form1" runat="server">
        <center>
        <asp:Button ID="btnShareMessage" class="btn btn-main btn-round-full" runat="server" Text="Siz de Paylaşın" OnClick="btnShareMessage_Click"></asp:Button>
        <asp:Repeater ID="rptBlogPosts" runat="server">
            <ItemTemplate>
                <h1><%# Eval("subject") %></h1>
                <img src="/images/blog/<%# Eval("image") %>" style="border-radius: 15px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);" width="1000px" height="500px" alt="Yazıya gitmek için aşağıdaki butona tıklayın." />
                <br /><br />
                <asp:Button ID="btnViewDetails" class="btn btn-main-2 btn-round-full" runat="server" Text="Detayları Gör" CommandName="ViewDetails" CommandArgument='<%# Eval("post_id") %>' OnCommand="btnViewDetails_Command" />
                <br /><br />
            </ItemTemplate>
        </asp:Repeater>
            </center>
