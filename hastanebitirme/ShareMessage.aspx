<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShareMessage.aspx.cs" Inherits="hastanebitirme.ShareMessage" %>
...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Mesajınızı Paylaşın | Novena</title>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-5 text-lg">Mesajınızı Paylaşın</h1>
        ...
        <center>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <asp:TextBox ID="txtName" class="form-control" placeholder="Adınız Soyadınız" runat="server"></asp:TextBox>
              </div>
            </div>

            <div class="col-lg-6">
              <div class="form-group">
                <asp:TextBox ID="txtMail" class="form-control" placeholder="Mail Adresiniz" runat="server"></asp:TextBox>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group">
                <asp:TextBox ID="txtSubject" class="form-control" placeholder="Konu" runat="server"></asp:TextBox>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group">
                <asp:TextBox ID="txtPhone" class="form-control" placeholder="Telefon Numaranız" runat="server"></asp:TextBox>
              </div>
            </div>
          </div>

          <div class="form-group-2 mb-4">
            <asp:TextBox ID="txtMessage" class="form-control" placeholder="Mesajınız" runat="server" Rows="8" TextMode="MultiLine"></asp:TextBox>
          </div>
        <div class="col-lg-6">
            <div class="form-group">
                <asp:FileUpload ID="fileUpload"  runat="server" Accept=".jpg, .jpeg, .png, .gif"></asp:FileUpload>
            </div>
        </div>

          <div>
            <asp:Button ID="btnSend" class="btn btn-main btn-round-full" runat="server" Text="Mesajı Gönder" OnClick="btnSend_Click"></asp:Button>
          </div>
                </div>
        </center>
    </form>
