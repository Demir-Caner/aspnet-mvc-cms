<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paneladmin.aspx.cs" Inherits="hastanebitirme.paneladmin" %>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-5 text-lg">Panel | Admin Ekle/Çıkar</h1>
        ...
        <center>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:BoundField DataField="user_name" HeaderText="Kullanıcı Adı" />
                    <asp:BoundField DataField="password" HeaderText="Şifre" />
                    <asp:BoundField DataField="first_name" HeaderText="Adı" />
                    <asp:BoundField DataField="last_name" HeaderText="Soyadı" />
                    <asp:BoundField DataField="phone_number" HeaderText="Telefon" />
            ...
            <div style="padding-left:500px; padding-right:500px;">
                ...
                <asp:TextBox ID="txtData1" class="form-control" placeholder="Kullanıcı Adı" runat="server"></asp:TextBox><br />
                <asp:TextBox ID="txtData2" class="form-control" placeholder="Şifre" runat="server"></asp:TextBox><br />
                <asp:TextBox ID="txtData3" class="form-control" placeholder="Adı" runat="server"></asp:TextBox><br />
                <asp:TextBox ID="txtData4" class="form-control" placeholder="Soyadı" runat="server"></asp:TextBox><br />
                <asp:TextBox ID="txtData5" class="form-control" placeholder="Telefon" runat="server"></asp:TextBox><br />
                <asp:TextBox ID="txtData6" class="form-control" placeholder="Mail" runat="server"></asp:TextBox><br />
                ...
                <asp:Button ID="Button3" class="btn btn-main-2 btn-round-full" runat="server" Text="Ekle" OnClick="Button3_Click"></asp:Button>
            </div>
        </center>
    </form>
